          ...
          <div class="row">
              <div class="col-md-12">
                  <div class="admin-content-header">
                    <h1>Интерес </h1>
                    <nuxt-link :to="'/admin/interes'">Назад</nuxt-link>
                  </div>
                  <div class="card">
                  ...
                  <div class="admin-lots-list">
                    <AdminLotsItemsList :items="interes.order"
...
export default {
  ...
  data () {
    ...
    methods: {
        ...
        async getOrder () {
          const response = await this.$axios.$get('/get-interes/'+this.$route.params.id)
          ...
          response.interes.date = formatDate(response.interes.date)
          response.interes.remove = false
