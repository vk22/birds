<template>
    <div class="subscribe-modal-wrap">
      ...
      <div class="heading"><span>Подпишитесь на наши новости</span></div>
      ...
      <div class="subscribe-modal-container">
              ...
              <div class="field">
                    <div class="sub-oferta">
                        <p v-html="$t('subscribe.policyText')"></p>
              ...
              <div class="field is-grouped subscribe-form-footer">
                <div class="control">
                  <button class="btn subscribe-send" @click="sendEmail()">{{ $t('subscribe.send') }}</button>
                </div>
              </div>
