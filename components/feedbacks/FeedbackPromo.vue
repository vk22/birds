<template>
    <div class="feedback-promo-wrap">
    
      <div class="heading" v-if="!responseStatus"><span>{{ title }}</span></div>
      <div class="line" v-if="!responseStatus"></div>

      <div class="feedback-modal-container" v-if="!responseStatus">
      ...
      async sendFeedback() {
        ...
        if (this.feedback.email != '' && !this.validEmail(this.feedback.email)) {
         ...
         if (!this.errors.length) {
           ...
           console.log('this.promo.title ', this.promo.title)

          const response = await this.$axios.$post('/send-promo-request/', {promo: this.promo.title, feedback: this.feedback})
